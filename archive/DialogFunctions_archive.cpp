// Archived on 2026-02-11 from src/DialogFunctions.cpp
#include "DialogFunctions_archive.h"
#include <iostream>
#include <fstream>
#include <windows.h>
#include <locale>
...
// ===== ファイルから初期入力を読み込む関数 =====
std::string load_initial_input_from_file(const std::string& directory) {
